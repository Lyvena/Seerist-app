 ...
 * 
 * Seerist brand system — colors resolve from config.desktop.themeTokens CSS variables.
 *
 * Color Philosophy:
 * - Primary (#0d9488): main CTAs, dock active, links
 * - Highlight (#ff5757): AI assistant FAB and accent affordances
 * - Contrast (#06b6d4): energetic gradient accents
...
/** Seerist palette — primary teal + highlight coral, via theme tokens */
export const brand = {
  primary: {
