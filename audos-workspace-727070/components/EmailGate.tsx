...
export default function EmailGate({
  ...
  const footerBackground = palette?.primaryScale?.['900'] || palette?.text?.primary || '#09625a';
  ...
  return (
    ...
    >
      ...
      <section
        ...
        style={{ background: heroHasVideo ? footerBackground : heroGradient }}
      >
        {heroHasVideo && (
          <video
            src={heroVideoUrl}
        ...
        >
          <div className="max-w-3xl space-y-5">
            ...
            <h1
              ...
              style={{ color: '#ffffff' }}
            >{"Become who you set out to be"}</h1>
            <p
              className="max-w-2xl text-lg leading-8"
              style={{ color: 'rgba(255,255,255,0.78)' }}
            >
              The outcome you actually want — without the usual friction.
            </p>
      ...
      <footer className="px-6 py-12" style={{ backgroundColor: footerBackground, color: 'rgba(255,255,255,0.88)' }}>
        <div className="max-w-6xl mx-auto flex flex-col gap-6 sm:flex-row sm:items-start sm:justify-between">
          ...
          <nav className="flex flex-wrap gap-x-8 gap-y-2 text-sm">
            <a href="#features" className="transition-colors hover:text-white" style={{ color: 'rgba(255,255,255,0.72)' }}>Benefits</a>
            <a href="#how-it-works" className="transition-colors hover:text-white" style={{ color: 'rgba(255,255,255,0.72)' }}>How it works</a>
            <a href="#faq" className="transition-colors hover:text-white" style={{ color: 'rgba(255,255,255,0.72)' }}>FAQ</a>
          </nav>
        </div>
        <div
